                  ...
                  child: GlassCard(
                    child: ListTile(
                      ...
                      leading: Container(
                        ...
                        child: FaIcon(run.type.icon, color: AppColors.primary, size: 20),
                      ),
                      title: Text(
                        DateFormat('EEEE, MMM d, yyyy').format(run.date),
                        style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                      ),
                      subtitle: Padding(
                        padding: const EdgeInsets.only(top: 4.0),
                        child: Text(
                          "${run.distance.toStringAsFixed(2)} km • ${run.duration.inMinutes} mins • ${run.pace}",
